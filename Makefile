...
CPP_FLAGS	+= -Iinclude
CC_FLAGS	+= -O1 -G0 -quiet -fverbose-asm -fgnu-linker -fcommon -mgas -msoft-float
AS_FLAGS	+= -Iinclude -march=r3000 -mtune=r3000 -mabi=32 -no-pad-sections -O1 -G0

CPP	:= mipsel-linux-gnu-cpp 
CC	:= ./cc1-psx-26
#CC	:= wine CC1PSX.EXE $(CC_FLAGS)
#CC	:= dosemu -quiet -dumb -K . -E "CC1PSX33.EXE ${CC_FLAGS}"
